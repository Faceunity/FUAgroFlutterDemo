...
class ZegoExpressImpl {
  ...
  static Future<void> fuItemSetParam(String name, double param) async {
    print("fuItemSetParam $name");
    return await _channel.invokeMethod('fuItemSetParam', {
      'name': name,
      'param': param
    });
  }
  ...
  /// 美颜
  Future<void> updateBeautiful(Map param) async{
    return await ZegoExpressImpl._channel.invokeMethod('updateBeautiful', param);
  }
}
